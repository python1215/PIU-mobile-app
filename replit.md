...
- July 11, 2025. Fixed cascading dropdown form validation errors: resolved "Select a valid choice" validation failures by correcting field relationships in Social & Environmental forms, updated project-investment type relationships from project_id to project field, fixed region-district-settlement cascading dropdowns to use proper field mappings (region_code, district_code), added custom validation for type_of_investment field to ensure selected investment types belong to chosen projects, enhanced form queryset initialization for both create and edit operations
