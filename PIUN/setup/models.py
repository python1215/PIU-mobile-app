...
class SetupPDO(models.Model):
    """Project Development Objectives Setup Model"""
    pdoID = models.AutoField(primary_key=True)
    pdo_title = models.CharField(max_length=300, unique=True, null=False, 
                                help_text="Enter the Project Development Objective title")
    pdo_description = models.TextField(null=False, blank=False,
                                     help_text="Detailed description of the PDO")
    pdo_indicator = models.CharField(max_length=500, null=True, blank=True,
                                   help_text="Key performance indicator for this PDO")
    target_value = models.CharField(max_length=100, null=True, blank=True,
                                   help_text="Target value or outcome expected")
    baseline_value = models.CharField(max_length=100, null=True, blank=True,
                                    help_text="Baseline value at project start")
    target_date = models.DateField(null=True, blank=True,
                                 help_text="Expected completion date for this PDO")
    responsible_unit = models.CharField(max_length=200, null=True, blank=True,
                                      help_text="Unit or department responsible for this PDO")
    status = models.CharField(max_length=50, 
                            ...
                            default='not_started',
                            help_text="Current status of the PDO")
    is_active = models.BooleanField(default=True, 
                                  help_text="Whether this PDO is currently active")
    date = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    loginUser = models.ForeignKey(settings.AUTH_USER_MODEL,
                                  on_delete=models.CASCADE,
                                  related_name='setup_pdos')
