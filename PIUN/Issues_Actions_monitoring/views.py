...
def export_issues_excel(request):
    ...
    for row, issue in enumerate(issues, 2):
        data = [
            ...
            issue.issue_action_type.kpi_for_contract if issue.issue_action_type else '',
    ...
    if issues.exists():
        ...
        for issue in issues:
            ...
            details_data = [
                ...
                ('Type', issue.issue_action_type.kpi_for_contract if issue.issue_action_type else 'N/A'),
