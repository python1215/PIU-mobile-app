...
public class Jmc {
    ...
    @OneToMany(mappedBy = "jmc", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonIgnore
    private List<JmcMonitoringMilestone> milestones = new ArrayList<>();

    public Jmc() {}

    public List<JmcMonitoringMilestone> getMilestones() { return milestones; }
    public void setMilestones(List<JmcMonitoringMilestone> milestones) { this.milestones = milestones; }
