...
function SystemSetup() {
  ...
  const tabConfig = useMemo(() => ({
    ...
    identificationDocuments: { endpoint: '/api/setup/identification-documents', idField: 'id', label: 'Type of Identification Document',
      columns: [{ key: 'docId', label: 'Doc ID' }, { key: 'identityDocument', label: 'Identification Document' }],
      fields: [
    ...
    kpiEssOhs: { endpoint: '/api/setup/kpi-ess-ohs', idField: 'id', label: t('setup.kpiEssOhs'),
      columns: [{ key: 'id', label: 'ID' }, { key: 'indicator', label: t('setup.indicator') }, { key: 'essOhsType.description', label: t('setup.essOshMonitoringTypes') }],
      fields: [
        { name: 'indicator', label: t('setup.indicator'), placeholder: 'Enter indicator' },
        { name: 'essOhsTypeId', label: t('setup.essOshMonitoringTypes'), type: 'select', dataKey: 'essOshMonitoringTypes', valueField: 'id', displayField: 'description', relationField: 'essOhsType', placeholder: 'Select ESS & OHS Type...' }
      ],
      relatedDataKeys: ['essOshMonitoringTypes'] },
